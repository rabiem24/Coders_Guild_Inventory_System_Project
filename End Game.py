...
def main_menu():
    ...
    #Generate Button
    generate_report_button = Button(leftmidframe, text="Generate Report", font='times 10 bold', bd=2, relief='raise', width=15)
...
def add_item():
    ...
    #Submit Button
    submit = Button(screen2, text="Submit",bg="lightgreen", font='times 18 bold', width=17,command=submit_item)
